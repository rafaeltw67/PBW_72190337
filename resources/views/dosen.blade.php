                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->pakar }}</td>
                                    <td>
                                        <a href="/dosen/editdosen/{{ $d->id }}" class="btn btn-success"><i class="bi bi-pencil-square"></i>Edit</a>
                                        <a href="/dosen/hapusdosen/{{ $d->id }}" class="btn btn-danger"><i class="bi bi-x-square"></i>Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
