...
class DosenController extends Controller
{
    ...
    public function simpandosen(Request $request){
        ...
        return redirect ("/dosen")->with('alert', 'Data Dosen Berhasil Disimpan!');
}
    ...
    public function updatedosen($id, Request $request)
    {
        ...
        $dosen -> pakar = $pakar;
        $dosen->save();
        return redirect ("/dosen")->with('alert', 'Data Dosen Berhasil Diubah!');
    }
    ...
    public function hapusdosen($id)
    {
        $dosen = Dosen::find($id);
        $dosen->delete();
        return redirect('/dosen')->with('alert', 'Data Dosen Berhasil Dihapus!');
        }
}